...
/**
 ** \file /home/maxim/Desktop/work/compiler-checkpoint_2/Source/parsers/parser.hh
 ** Define the yy::parser class.
 */

// C++ LALR(1) parser skeleton written by Akim Demaille.

// Undocumented macros, especially those whose name_ start with YY_,
// are private implementation details.  Do not rely on them.

#ifndef YY_YY_HOME_MAXIM_DESKTOP_WORK_COMPILER_CHECKPOINT_2_SOURCE_PARSERS_PARSER_HH_INCLUDED
# define YY_YY_HOME_MAXIM_DESKTOP_WORK_COMPILER_CHECKPOINT_2_SOURCE_PARSERS_PARSER_HH_INCLUDED
// "%code requires" blocks.
#line 9 "parsers/parser.y"
...
#line 57 "/home/maxim/Desktop/work/compiler-checkpoint_2/Source/parsers/parser.hh"
...
namespace yy {
#line 191 "/home/maxim/Desktop/work/compiler-checkpoint_2/Source/parsers/parser.hh"
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // class_declaration
      // main_class
      char dummy2[sizeof (ClassStatement*)];
      ...
      // extends
      char dummy7[sizeof (ExtendsStatement*)];
      ...
      // statements
      char dummy12[sizeof (Statements*)];
    ...
    /// Whether the content is built: if defined, the name_ of the stored type.
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, ClassStatement*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const ClassStatement*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, ExtendsStatement*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const ExtendsStatement*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yytype)
    {
      ...
      case 68: // main_class
        value.template destroy< ClassStatement* > ();
        break;
      ...
      case 66: // extends
        value.template destroy< ExtendsStatement* > ();
        break;
  ...
  private:
    ...
    /// Convert the symbol name_ \a n to a form suitable for a diagnostic.
    static std::string yytnamerr_ (const char *n);


    /// For a symbol, its name_ in clear.
  ...
  private:
    ...
    {
      yyeof_ = 0,
      yylast_ = 479,     ///< Last index in yytable_.
    ...
    , location (std::move (that.location))
  {
    switch (this->type_get ())
    {
      ...
      case 67: // class_declaration
      case 68: // main_class
        value.move< ClassStatement* > (std::move (that.value));
        break;
      ...
      case 66: // extends
        value.move< ExtendsStatement* > (std::move (that.value));
        break;
    ...
    , location (that.location)
  {
    switch (this->type_get ())
    {
      ...
      case 67: // class_declaration
      case 68: // main_class
        value.copy< ClassStatement* > (YY_MOVE (that.value));
        break;
      ...
      case 66: // extends
        value.copy< ExtendsStatement* > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->type_get ())
    {
      ...
      case 67: // class_declaration
      case 68: // main_class
        value.move< ClassStatement* > (YY_MOVE (s.value));
        break;
      ...
      case 66: // extends
        value.move< ExtendsStatement* > (YY_MOVE (s.value));
        break;
...
#line 2357 "/home/maxim/Desktop/work/compiler-checkpoint_2/Source/parsers/parser.hh"





#endif // !YY_YY_HOME_MAXIM_DESKTOP_WORK_COMPILER_CHECKPOINT_2_SOURCE_PARSERS_PARSER_HH_INCLUDED
